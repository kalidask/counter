...
public class CounterServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>" + this.titleMessage + "your IP "+  InetAddress.getByName(request.getHeader("x-forwarded-for"))!= null ?InetAddress.getByName(request.getHeader("x-forwarded-for")):"Not Forwarded" +"</title>");
        out.println("</head>");
